...
; Uses !define /redef to safely override any values electron-builder pre-defines
; ─────────────────────────────────────────────────────────────────────────────

!macro customHeader
  BrandingText "Mus-IQ ${VERSION}  •  Track your music. Know your taste."

  !define /redef MUI_WELCOMEPAGE_TITLE "Willkommen bei Mus-IQ Desktop"
  !define /redef MUI_WELCOMEPAGE_TEXT "Mus-IQ trackt deinen Spotify-Verlauf automatisch im Hintergrund.$\r$\n$\r$\n• Echtzeit Song-Tracking$\r$\n• Detaillierte Hörstatistiken$\r$\n• Discord Rich Presence$\r$\n• Läuft unsichtbar im Systembereich$\r$\n$\r$\nKlicke auf Weiter um die Installation zu starten."

  !define /redef MUI_ABORTWARNING
  !define /redef MUI_ABORTWARNING_TEXT "Möchtest du die Installation wirklich abbrechen?"
!macroend
...
!macro customFinishPage
  !define /redef MUI_FINISHPAGE_TITLE "Mus-IQ Desktop ist bereit!"
  !define /redef MUI_FINISHPAGE_TEXT "Die Installation war erfolgreich.$\r$\n$\r$\nMelde dich mit deinem mus-iq.com Account an und starte dein Musik-Tracking.$\r$\n$\r$\nDie App läuft automatisch im Hintergrund."
  !define /redef MUI_FINISHPAGE_LINK "mus-iq.com öffnen"
  !define /redef MUI_FINISHPAGE_LINK_LOCATION "https://mus-iq.com"
  ...
  !ifndef HIDE_RUN_AFTER_FINISH
    ...
    FunctionEnd
    !define /redef MUI_FINISHPAGE_RUN
    !define /redef MUI_FINISHPAGE_RUN_FUNCTION "StartAppMusIQ"
    !define /redef MUI_FINISHPAGE_RUN_TEXT "Mus-IQ Desktop jetzt starten"
  !endif
...
!macro customUnWelcomePage
  !define /redef MUI_UNWELCOMEPAGE_TITLE "Mus-IQ Desktop deinstallieren"
  !define /redef MUI_UNWELCOMEPAGE_TEXT "Dieser Assistent entfernt Mus-IQ Desktop von deinem Computer.$\r$\n$\r$\nAlle deine Statistiken bleiben auf mus-iq.com erhalten.$\r$\n$\r$\nKlicke auf Weiter um fortzufahren."
